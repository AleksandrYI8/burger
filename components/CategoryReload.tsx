...
const CategoryReload: React.FC<Props> = ({ item, lang }) => {
  ...
  return (
    <li
      onClick={handleClick}
      className={`md:text-[14px] lg:text-[16px] flex whitespace-nowrap overflow-hidden min-w-fit gap-[5px] justify-center pt-[5px] pb-[5px] p-[8px] rounded-[15px] text-black items-center ${languageData.en === item.titles.en ? "bg-background" : "bg-white"}`}>

    ...
    <AppWrapper>
      <div className="bg-gray-100">
        ...
        <footer className=' text-black flex justify-between bg-white pl-[5%] pt-[2%] pr-[10%] pb-[2%] w-full' >
          <div className="sm:w-[25%] md:w-[25%] lg:w-[25%]">
            <Image src="/images/footerLogo.svg" alt="logo" width={300} height={200} />
          </div>

          <div className="flex sm:gap-[10%] md:gap-[10%] lg:gap-[20%]">
            <div className="">
              <h3 className='whitespace-nowrap sm:text-[14px] md:text-[16px] lg:text-[22px] xl:text-[24px] mb-[10px]' >{translation.footer.number}</h3>
              <p className='whitespace-nowrap sm:text-[14px] md:text-[13px] text-center'>+7(930)833-38-11</p>
            </div>


            <div className="">
              <h3 className='whitespace-nowrap sm:text-[14px] md:text-[16px] lg:text-[22px] xl:text-[24px] mb-[10px]' >{translation.footer.media}</h3>
              <div className="flex sm:gap-[10px] md:gap-[10px] gap-[20px] justify-center">

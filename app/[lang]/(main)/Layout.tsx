      ...
      <div className="bg-gray-100">
        <header className=' bg-gray-100 w-full mb-[3vh]'>
          <div className="bg-background rounded-b-[60%] mb-[30px]">
            ...
            <div className="flex mx-auto pb-[60px] md:gap-[30px] lg:gap-[50px] justify-center items-center">
              <div className="md:w-[20%] lg:w-[20%] xl:w-fit">
              <Image src="/images/burger.svg" alt="burder" width={250} height={250} />
              </div>
              <div className="">
                <h1 className='mb-5 md:leading-[7vh] lg:leading-[9vh] xl:leading-[9vh] 2xl:leading-[6vh] md:text-[35px]  lg:text-[50px] font-bold text-white'> {translation.header.headerTitle} <br /> <span className='text-orange-600' >{translation.header.headerTitleSec}</span></h1>
                <p className='md:text-[14px] lg:text-[16px] pl-[5px]'>{translation.header.deliv}<span className='font-bold'>599₽</span></p>
              </div>
            </div>
          </div>
          <ul className=" flex md:gap-[3%] lg:gap-[2%] scrollbar-hidden pr-[5%] pl-[5%] overflow-x-auto ">
        ...
        <div className="flex w-full">
          <aside className='md:mt-[5vh] lg:mt-[13vh] xl:mt-[10vh] sticky top-[5%] h-[20vh]  rounded-[15px] w-[25%] bg-white text-black ml-[5%] p-[1%]'>
